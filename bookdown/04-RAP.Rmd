...
```{r rap-statement, fig.cap='Ed Humpherson, Office for Statistics Regulation', out.width='80%', fig.asp=.75, fig.align='center', fig.alt='General Overview of why RAP is important', echo=FALSE}
knitr::include_graphics("./images/rap-statement.jpg")
```
...
```{r rap-overview, fig.cap='How RAP works', out.width='80%', fig.asp=.75, fig.align='center', fig.alt='How RAP works', echo=FALSE}
knitr::include_graphics("./images/rap-overview.jpg")
```
